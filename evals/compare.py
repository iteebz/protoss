...
def compare_runs(run1_id: str, run2_id: str) -> None:
    ...
    print(
        f"{'LLM:':<15} {config1.get('llm', 'N/A'):<10} vs {config2.get('llm', 'N/A')}"
    )
    print(
        f"{'Mode:':<15} {config1.get('mode', 'N/A'):<10} vs {config2.get('mode', 'N/A')}"
    )
    print(
    ...
    print(
        f"{'Seed:':<15} {config1.get('seed', 'random'):<10} vs {config2.get('seed', 'random')}"
    )
    print()
